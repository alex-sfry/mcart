    ...
    <div class="review-block" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
        <div class="review-text">
            <div class="review-block-title">
                ...
                <span class="review-block-description">
                    <?= $arItem["DISPLAY_ACTIVE_FROM"] . ' ' . GetMessage('YEAR') . ', ' . $arItem['DISPLAY_PROPERTIES']['POSITION']['VALUE'] . ', ' . $arItem['DISPLAY_PROPERTIES']['COMPANY']['VALUE']; ?>
                </span>
            </div>
        ...
        <div class="review-img-wrap">
            ...
            <? if ($arParams["DISPLAY_PICTURE"] != "N" && is_array($arItem["DETAIL_PICTURE"])) : ?>
                <img src="<?= $resized_detail_image['src'] ?>" alt="<?= $arItem["DETAIL_PICTURE"]["ALT"] ?>">
            <? else : ?>
